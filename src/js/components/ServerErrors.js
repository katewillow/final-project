"use strict";
import {NO_RESULT_TITLE} from "../constants/constants";
import {NO_RESULT_SUBTITLE} from "../constants/constants";
import {NO_NETWORK_TITLE} from "../constants/constants";
import {NO_NETWORK_SUBTITLE} from "../constants/constants";
